...
export class PmTableComponent {
  ...
  // 类型
  @Input() type;
  /** 导出，[fileType, this.mySelection] */
  @Output() onExport = new EventEmitter<any>();
  /** 换页，{ 'pageIndex': this.pageIndex, 'pageSize': this.pageSize } */
  ...
  allCols = [
    ...
    { "name": "对象名称", "hidden": false, "width": "130" },
    { "name": "端口标注", "hidden": false, "width": "130" },
    { "name": "线路号", "hidden": false, "width": "130" },
    { "name": "性能分组", "hidden": false, "width": "130" },
    { "name": "性能代码类型", "hidden": false, "width": "130" },
    { "name": "性能代码", "hidden": false, "width": "130" },
    { "name": "英文性能代码", "hidden": false, "width": "130" },
    { "name": "性能值", "hidden": false, "width": "130" },
    { "name": "单位", "hidden": false, "width": "130" },
    { "name": "开始时间", "hidden": false, "width": "130" },
    { "name": "结束时间", "hidden": false, "width": "130" },
  ];
  ...
  doExport(fileType: string) {
    ...
    this.onExport.emit([fileType, this.mySelection]);
    // this.unmPmService.exportData(this.type, fileType, (res) => {
