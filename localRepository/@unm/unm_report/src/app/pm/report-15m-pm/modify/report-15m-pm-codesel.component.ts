 ...
 * @export
 * @class Report15mPmModifyCodeSelComponent
 */
@Component({
...
export class Report15mPmModifyCodeSelComponent implements OnInit {
  /**
   * 构造函数
  ...
  previous() {
    this.router.navigate(['../../modify/objectsel'],{relativeTo: this.route, skipLocationChange: true});
  }
